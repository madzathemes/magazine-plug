...
class Social_Count_Plus_Admin {
	...
	public function settings_menu() {
		$this->settings_screen = add_theme_page(
			__( 'mt Social Widget', 'social-count-plus' ),
			__( 'mt Social Widget', 'social-count-plus' ),
			'manage_options',
			'social-count-widget',
	...
	public function settings_page() {
		...
		$this->plugin_design   = get_option( 'socialcountplus_settings' );
		...
		if ( isset( $_GET['settings-updated'] ) && ! ( isset( $_GET['tab'] ) && 'design' == $_GET['tab'] ) ) {
			if ( true == $_GET['settings-updated'] ) {
				...
				$design          = get_option( 'socialcountplus_settings', array() );
				$design['icons'] = implode( ',', $icons );
				update_option( 'socialcountplus_settings', $design );
			}
		}
